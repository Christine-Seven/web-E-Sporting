...
$axure.internal(function($ax) {
    ...
    //    function InsertAfterBegin(dom, html_axure) {
    //        if(!IE) {
    //            var phtml;
    //            var range = dom.ownerDocument.createRange();
    //            range.selectNodeContents(dom);
    //            range.collapse(true);
    //            phtml = range.createContextualFragment(html_axure);
    //            dom.insertBefore(phtml, dom.firstChild);
    //        } else {
    //            dom.insertAdjacentHTML("afterBegin", html_axure);
    //        }
    //    }

    //    function InsertBeforeEnd(dom, html_axure) {
    //        if(!IE) {
    //            var phtml;
    //            var range = dom.ownerDocument.createRange();
    //            range.selectNodeContents(dom);
    ...
    //        } else {
    //            dom.insertAdjacentHTML("beforeEnd", html_axure);
    //        }
    //    }
